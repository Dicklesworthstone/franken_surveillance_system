...
impl Writer {
    ...
    pub(crate) fn u16(&mut self, n: u16) -> Result<(), Mp4Error> {
        self.put(&n.to_be_bytes())
    }
    pub(crate) fn u32(&mut self, n: u32) -> Result<(), Mp4Error> {
        self.put(&n.to_be_bytes())
    }
    pub(crate) fn u64(&mut self, n: u64) -> Result<(), Mp4Error> {
        self.put(&n.to_be_bytes())
    }
