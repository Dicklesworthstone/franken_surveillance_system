...
pub fn generate_slice(
    ...
    if force_ep {
        // Explicitly inject byte sequences that trigger emulation prevention 0x03
        // for each of the four values 0x00, 0x01, 0x02, and 0x03.
        let ep_pattern = [
            0x00, 0x00, 0x00, // becomes 0x00, 0x00, 0x03, 0x00
            0x00, 0x00, 0x01, // becomes 0x00, 0x00, 0x03, 0x01
            0x00, 0x00, 0x02, // becomes 0x00, 0x00, 0x03, 0x02
            0x00, 0x00, 0x03, // becomes 0x00, 0x00, 0x03, 0x03
        ];
