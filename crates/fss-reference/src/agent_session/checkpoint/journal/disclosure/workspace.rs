...
use crate::agent_session::workspace::{
    WorkspaceLimits, WorkspaceResume, WorkspaceRevision, WorkspaceWrite,
};
...
impl DurableDisclosureStore {
    ...
    pub fn resume_workspace(
        ...
        self.sessions
            .resume_workspace(principal, session, revision, now)
    }
    ...
    pub fn rebase_workspace(
        ...
        self.sessions
            .rebase_workspace(principal, refresh, request, now)
    }
}
