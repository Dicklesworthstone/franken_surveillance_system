...
/// cell of the same claim, so the earlier cell is the claim's previous version. `coalesce` is a
/// public API point with no production caller. For all 49 ordered class pairs,
