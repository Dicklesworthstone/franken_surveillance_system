...
pub use agent_operation::{
    ...
    CancellationRecord, CancelStage, CommitReceipt, DiagnosisDomain, ExplainQuestion,
    ExplainReceipt, FeedbackKind, FeedbackProposal, PreparedPlan, PreparedPlanStep,
    QueryReadReceipt, RepairAffordance, WaitWake, WaitWakeContract,
...
pub use hydration::{
    ...
    GraphNeighborhoodArtifact, H0_CONTENT, H0_LEVEL_ID, H0_LEVEL_NAME, H0_SCHEMA,
    H0_SEMANTIC_OWNER, H0Identity, H0IdentityParams, H1_CONTENT, H1_LEVEL_ID, H1_LEVEL_NAME,
    H1_OWNER, H1_SCHEMA, H1CellContext, H1ContentSpec, H1SemanticSynopsis, H1SynopsisParams,
    H2_CONTENT, H2_LEVEL_ID, H2_LEVEL_NAME, H2_OWNER, H2_SCHEMA, H2DecisionArtifact,
    H2DecisionArtifactParams, H2PrivacyClass, H4_CONTENT, H4_LEVEL_ID, H4_LEVEL_NAME, H4_OWNER,
    H4_SCHEMA, H4LaboratoryExpansion, H4LaboratoryExpansionParams, HYDRATION_VIEW_ID,
    ...
    LaboratoryArtifact, LaboratoryQuarantine, MAX_H1_CAPABILITIES, MAX_H1_CONTRADICTIONS,
