...
pub fn decoder_identity() -> [u8; 32] {
    [
        88, 142, 85, 98, 115, 169, 107, 216, 101, 118, 198, 8, 88, 247, 162, 119, 235, 9, 116, 161,
        239, 86, 22, 94, 145, 108, 119, 51, 80, 134, 132, 97,
    ]
}
...
pub fn decode_luma(
    ...
    if limits.maximum_bytes == 0
        ...
        || bytes.len() > limits.maximum_bytes
    {
