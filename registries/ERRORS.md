...
| `ERR-DEP-UNSTABLE-FEATURE-001` | FSS Rust source enables a nightly unstable feature with #![feature(...)] while no unstable-feature allowlist is registered | remove the feature gate or register an unstable-feature allowlist with owner and removal plan before enabling it |
